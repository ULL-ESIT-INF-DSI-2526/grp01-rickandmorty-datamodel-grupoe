...
describe("GestorPersonajes - Pruebas Unitarias", () => {
  ...
  it("debería agregar una dimensión correctamente", async () => {
    ...
    const nuevaDimension: Dimension = {
      id: "D-1",
      name: "Tierra",
      state: "activa",
      nivelTecnolog: 10,
  ...
  it("debería lanzar un error al agregar una dimensión con ID duplicado", async () => {
    ...
    await expect(gestor.agregarDimension(dimension2)).rejects.toThrow(
      "Ya existe una dimensión con el ID D-2",
    );
  });
  ...
  it("debería lanzar un error al agregar una dimensión con nivel de tecnología fuera de 1-10", async () => {
    ...
    await expect(gestor.agregarDimension(dimensionInvalida)).rejects.toThrow(
      "El nivel tecnológico debe estar entre 1 y 10. Valor recibido: 15",
    );
  });
  ...
  it("debería lanzar un error al eliminar una dimensión inexistente", async () => {
    await expect(gestor.eliminarDimension("D-999")).rejects.toThrow(
      "No existe una dimensión con el ID D-999",
    );
  });
  ...
  it("debería modificar una dimensión existente correctamente", async () => {
    const dimensionOriginal: Dimension = {
      id: "D-1",
      name: "Tierra",
      state: "activa",
      nivelTecnolog: 10,
    ...
    await gestor.modificarDimension("D-1", {
      name: "Tierra-Prime",
      state: "cuarentena",
    });
  ...
  it("debería lanzar un error al intentar modificar una dimensión que no existe", async () => {
    await expect(
      gestor.modificarDimension("D-999", { name: "Dimensión Inexistente" }),
    ).rejects.toThrow("No existe una dimensión con el ID D-999");
  });
  ...
  it("debería lanzar un error al intentar modificar una dimensión con nivel tecnológico fuera de 1-10", async () => {
    ...
    await expect(
      gestor.modificarDimension("D-1", { nivelTecnolog: 15 }),
    ).rejects.toThrow(
      "El nivel tecnológico debe estar entre 1 y 10. Valor recibido: 15",
    );
  });
